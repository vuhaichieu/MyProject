...
public class SessionTakeAttDBContext extends DBContext<SessionTakeAtt> {
    ...
    public void updateAttandance(SessionTakeAtt model) {
        try {
            ...
            //add new attandances
            for (AttandanceTakeAtt att : model.getAtts()) {
    ...
    @Override
    public void insert(SessionTakeAtt model) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public void update(SessionTakeAtt model) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public void delete(SessionTakeAtt model) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public SessionTakeAtt get(int id) {
        try {
    ...
    @Override
    public ArrayList<SessionTakeAtt> list() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
